...
export async function getMdxSource(postContents) {
    ...
    const remark_1 = await import("remark");
    const remark_mdx_1 = await import("remark-mdx");
    const serialize_1 = await import("next-mdx-remote/serialize");
    ...
    const mdxSource = await (0, serialize_1.serialize)(contentHtml);
    return mdxSource;
}
