...
function ExpandingArrow({ className }) {
    return (<div className="relative flex items-center group">
      ...
      <svg className={`${className ? className : 'w-4 h-4'} absolute opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all`} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" width="16" height="16">
